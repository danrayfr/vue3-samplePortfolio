<template>
            ...
            <nav id="store" class="w-full z-30 top-0 px-6 py-1">
				...
				Blog
                    ...
                    <div class="flex items-center" id="store-nav-content">
                        ...
                        <a class="pl-3 inline-block no-underline hover:text-gray-600" href="#">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <div class="pt-3 flex items-center justify-between">
                        ...
                        <svg class="h-6 w-6 fill-current text-gray-900 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <div class="relative z-0 mx-auto hero-height">
        ...
        <div class="px-4 sm:px-0 absolute inset-0 text-white">
            <div class="container mx-auto h-full flex flex-col justify-center">
                <div class="mt-1 text-md font-medium">Welcome to</div>
                <div>
                    <img src="/images/logo/dray-logo-gold.png" class="h-auto w-auto mt-4">
                </div>
                <!--div class="mt-1 text-6xl font-medium text-white">
                    Immersive Studios
                </div-->
                <div class="mt-2 sm:w-1/2">
                    {{settings.hero_description_url}}
                </div>
            
                <!--div class="mt-8 text-blue-300">
                    <svg class="h-10 animate-pulse" 
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
